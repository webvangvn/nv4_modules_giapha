...
<form action="{NV_BASE_ADMINURL}index.php" method="post">
	...
	<table summary="" class="tab1">
		...
		<tbody>
			<tr>
				<td align="right" nowrap="nowrap">{LANG.u_image}: </td>
				<td colspan="3">
				<input style="width:320px" name="image" id="image" value="{DATA.image}" type="text">
				&nbsp;&nbsp;
				<input value="Browse server" name="selectimg" type="button">
				</td>
			</tr>
		</tbody>
		<tbody class="second">
