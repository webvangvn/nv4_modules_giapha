...
<div id="module_show_list">
	<center>
		<b>Hu?ng d?n:</b><i>Click chu?t ph?i lên t?ng thành viên d? có th? c?p nh?t ho?c thêm m?i v? con.</i>
	</center>
	<br>
	<!-- BEGIN: foldertree -->
	...
	<div class="contextMenu" id="menu_genealogy_show">
		<ul>
			...
			<li id="news2">
				<img src="{NV_BASE_SITEURL}js/contextmenu/icons/copy.png" /> Thêm V?
			</li>
			<li id="news3">
				<img src="{NV_BASE_SITEURL}js/contextmenu/icons/copy.png" /> Thêm ch?ng
			</li>
			<li id="edit">
	...
	$(document).ready(function() {
		...
		$('#foldertree span').contextMenu('menu_genealogy_show', {
			...
			bindings : {
				...
				'delete' : function(t) {
					if(confirm('B?n có ch?c ch?n xóa thành viên, xóa thành viên này h? th?ng x? xóa t?t c? các thành viên là v?, con, cháu ..')) {
						var r_split = t.id.split("_");
